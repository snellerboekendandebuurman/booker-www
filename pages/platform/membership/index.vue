<template>
  <div class="m-4">
    <MembershipAddModal :modal-open="modalAddOpen" @toggle-modal="toggleAddModal"/>
    <ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
    <MembershipAddCard @toggle-modal="toggleAddModal"/>
    <Observer>
      <li v-for="membership in membershipsService.memberships" :key="membership.id" class="col-span-1 flex flex-col divide-y divide-gray-200 text-center shadow">
