<template>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                {{ $t("platform.reservations.cancel_reservation_confirmation_title") }}
                </DialogTitle>
                <div class="mt-2">
                  <p class="text-sm dark:text-slate-400 text-slate-500">
                    {{ $t("platform.reservations.cancel_reservation_confirmation_text") }}
                  </p>
                </div>
                ...
                <div class="mt-6 flex justify-between">
                  ...
                  >
                    <BaseSpinnerSmall
                      ...
                      spinner-text="global.cancel"
                      button-text="global.cancel"
                    />
                  </BaseButton>
                </div>
              </DialogPanel>
  ...
  defineEmits(['closeModal', 'cancelReservation']);
