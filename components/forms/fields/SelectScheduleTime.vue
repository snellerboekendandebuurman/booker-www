<template>
    <div>
        <label for="schedule_time" class="block text-sm font-medium leading-6 text-slate-700 dark:text-slate-300">{{
        ...
        <div class="flex mt-1 justify-between items-center relative">
            ...
            <ErrorMessage name="schedule_time" as="p" class="dark:text-pink-200 text-pink-400" />
        </div>
    </div>
</template>
